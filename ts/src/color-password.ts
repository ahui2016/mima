...
export function create_color_pwd(comp: mjComponent) {
  return m("div")
    .addClass("mb-3")
    .append(
      m("label")
      ...
      m("div")
        ...
        .append(
          ...
          util
            ...
            .addClass("ml-2"),
          "， 易读模式/编辑模式: ",
          util.LinkElem("#", { text: "toggle" }).attr({id:'ColorPwdToggleBtn'}).on("click", (event) => {
...
function toggleColorPwd(comp: mjComponent) {
  comp.elem().toggle();
